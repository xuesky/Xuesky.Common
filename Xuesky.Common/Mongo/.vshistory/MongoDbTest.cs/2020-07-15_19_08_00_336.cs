...
namespace Xuesky.Common.MongoDB
{
    public class MongoDbTest
    {
        public MongoDbTest()
        {
            ...
            mongoDb.UpdateManyById("5f0ec96fd3d944988cd0457b", update.Set("Name", "我是被修改过的名字"));

            mongoDb.UpdateOneById<Book>("5f0ec96fd3d944988cd0457b", b => new Book { BookName = "我是被表达式修改过的" });
            //替换
