...
namespace Xuesky.Common
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Func<AsyncCallback, object, IAsyncResult> func = (call, o) =>
                  {
                      using (var httpClient = new HttpClient())
                      {
            ...
            var taskAsync = Task.Factory.FromAsync(func(callback, "alll"), func.EndInvoke);
            taskAsync.ContinueWith(s =>
            {
                Console.WriteLine(s.Result.AsyncState);
            });
